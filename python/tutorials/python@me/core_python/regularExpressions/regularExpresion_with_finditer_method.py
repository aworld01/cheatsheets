...
\s: Returns a match where the string contains a whiteSpace, tab, or newline character.
\S: Returns a match where the string doesn't contain a whiteSpace, tab, or newline character.
